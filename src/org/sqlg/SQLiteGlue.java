...
public class SQLiteGlue {
  ...
  /** Interface to C language function: <br> <code> const char *  sqlg_st_column_text(ptrdiff_t stmt, int col); </code>    */
  public static native String sqlg_st_column_text(long stmt, int col);

  /** Interface to C language function: <br> <code> int sqlg_st_finish(ptrdiff_t stmt); </code>    */
  public static native int sqlg_st_finish(long stmt);

  /** Interface to C language function: <br> <code> int sqlg_st_step(ptrdiff_t stmt); </code>    */
  public static native int sqlg_st_step(long stmt);
